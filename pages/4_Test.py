...
def get_answers(question, model_filter, knowledgebase_filter):
    ...
    try:
        ...
        response = opensearch.query_gartner(question, "garther-demo")
...
st.header('Test bed to test new feature :technologist:')
st.caption('by Leveraging Foundational Models from :blue[Amazon Bedrock and Amazon OpenSearch Serverless as Vector Engine]')
st.divider()
question = st.text_input("Ask me anything:", "Show me total claim made by SecureGuard")
